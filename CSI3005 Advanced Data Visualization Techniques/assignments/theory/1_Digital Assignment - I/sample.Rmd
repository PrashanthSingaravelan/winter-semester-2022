...
```{r}
plot(nuts0.spdf,border=NA,bg="#A6CAE0")
plot(world.spdf,border=NA,col="#E3DEBF",add=TRUE)
```

```{r}
#plot(nuts0.spdf,border="grey",add=TRUE,col="#D1914D")
propSymbolsLayer(spdf=nuts0.spdf,df=nuts0.df,var="pop1999",symbols = "circle",col="#920000")
```
